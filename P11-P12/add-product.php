<?php
	...
	if(isset($_GET['id'])){
      ...
      echo 'hi';
			if($order->id == $_GET['id']){
        $pros = $order->products;
        $pro = $pros->addChild('product');
        $pro->addChild('price', 'Price');
        $pro->addChild('value', 'Product Name');
        $pro->addChild('Quantity');
        // $orders->session_save_path('orderInfo.xml');
        echo $pro;
				break;
			}
		}
                  ...
                  <td>
                    ...
                    <div class="Order-info">
                      <table border="border" class="order">
                        ...
                        echo '
                    </div><input name="id" value='.$order->id.' readonly>
