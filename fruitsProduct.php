...
if(isset($_GET['id'])){
  foreach ($xml->fruits->product as $product) {
...
<form action="" class="search-form">
  ...
  <label for="search-box" class="fas fa-search"></label>
	...
	<!--Product section-->
	<div class="fruitsProduct">
    <img  id="itemImgLink" src="<?= $image?>" alt="image of <?= $image?>" height="250"/>
		...
		<input type="text" name="fruits" id="quantity"  maxlength="2" onkeyup="displayPrice()" window.onload = function()> </br>
