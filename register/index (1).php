...
<!-- header section starts -->
	...
	<header class="header">
		  ...
		  <a href="index.html" class="logo"> <i class="fas fa-shopping-basket"> </i> Grocery King </a>
		  ...
		  <nav class="navbar">
			...
			<?php
				...
				// Verify if the user is logged in by the username session variable and welcome him
				if (isset($_SESSION['username']))
				{
					echo "<p style = font-size:20px;> Welcome ". $_SESSION['username']."!</p>";
...
<!-- home section starts -->
	...
	<section class="home" id="Home">
		...
		<div class="content">
			<h3><span class="green">Fresh</span> Produce Delivered To Your <span class="orange">Doorstep</span></h3>
		</div>
		</a>
