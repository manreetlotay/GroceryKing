...
<head>
  ...
  <title> Grocery King All Products </title>
...
<section class="allproducts" id="allproducts">
  ...
  <div class="swiper product-slider">
    ...
    <div class="swiper-wrapper">
      ...
      <?php
                $fruitsProduct = simplexml_load_file("productInfo.xml");
                foreach ($fruitsProduct->fruits->product as $product){
                    $id = $product->id;
                    $image = $product->image;
                    $name = $product->name;
      ...
      <div class="swiper-slide box-container">
        <div class="box">
          <a href="fruitsProduct.php?id=<?= $id ?>" class="logo"><img src="<?= $image ?>" alt="<?= $name ?>"></a>
          <a href="fruitsProduct.php?id=<?= $id ?>" class="logo"><h3> <?= $name ?> </h3></a>
    ...
    <div class="swiper product-slider">
      ...
      <div class="swiper-wrapper">
        ...
        <?php
                  $vegProduct = simplexml_load_file("productInfo.xml");
                  foreach ($vegProduct->vegetables->product as $product){
                      $id = $product->id;
                      $image = $product->image;
                      $name = $product->name;
                      $inventory = $product->inventory;
        ...
        <div class="swiper-slide box-container">
          <div class="box">
            <a href="vegProduct.php?id=<?= $id ?>" class="logo"><img src="<?= $image ?>" alt="<?= $name ?>"></a>
            <a href="vegProduct.php?id=<?= $id ?>" class="logo"><h3> <?= $name ?> </h3></a>
            <div class="price"> <?= $price ?>/Quantity </div>
          </div>
        </div>
    ...
    <div class="swiper product-slider">
      ...
      <div class="swiper-wrapper">
        ...
        <?php
                  $meatProduct = simplexml_load_file("productInfo.xml");
                  foreach ($meatProduct->meat->product as $product){
                      $id = $product->id;
                      $image = $product->image;
                      $name = $product->name;
                      $inventory = $product->inventory;
        ...
        <div class="swiper-slide box-container">
          <div class="box">
            <a href="meatProduct.php?id=<?= $id ?>" class="logo"><img src="<?= $image ?>" alt="<?= $name ?>"></a>
            <a href="meatProduct.php?id=<?= $id ?>" class="logo"><h3> <?= $name ?> </h3></a>
            <div class="price"> <?= $price ?>/Quantity </div>
          </div>
        </div>
