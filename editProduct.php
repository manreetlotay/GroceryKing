...
<main>
  <div class="container">
      <h1 class="page-header text-center" style="color: orange;">Edit Product </h1>
    ...
    <div class="row form-group">
      ...
      <div class="col-sm-10">
        ...
        <div class="footer" style="margin-left:126rem; ">
            ...
            <button type="submit" name="edit" class="btn btn-success"><span class="fa-solid fa-floppy-disk"></span> Update </button>
  </form>
        </div>
