...
if(isset($_GET['id'])){
  foreach ($xml->dairy->product as $product) {
...
<form action="" class="search-form">
  ...
  <label for="search-box" class="fas fa-search"></label>
    ...
    <img src="<?= $image?>" alt="image of <?= $image?>" height="250"/>
		...
		<input type="text" name="dairy" id="quantity"  maxlength="2" onkeyup="displayPrice()" window.onload = function()> </br>
